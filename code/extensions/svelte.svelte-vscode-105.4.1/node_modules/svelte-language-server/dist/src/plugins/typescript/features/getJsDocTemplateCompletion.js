...
function getJsDocTemplateCompletion(fragment, lang, filePath, offset) {
    ...
    const textEditRange = (0, documents_1.mapRangeToOriginal)(fragment, vscode_languageserver_1.Range.create(fragment.positionAt(start), fragment.positionAt(offset + ((_b = (_a = suffix === null || suffix === void 0 ? void 0 : suffix[0]) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0))));
