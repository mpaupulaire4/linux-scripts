...
async function getSvelteIgnoreEdit(svelteDoc, ast, diagnostic) {
    ...
    const diagnosticStartOffset = (0, documents_1.offsetAt)(generatedStart, transpiled.getText());
    const diagnosticEndOffset = (0, documents_1.offsetAt)(generatedEnd, transpiled.getText());
    const offsetRange = {
        pos: diagnosticStartOffset,
        end: diagnosticEndOffset
    };
    const node = findTagForRange(html, offsetRange);
    const nodeStartPosition = (0, documents_1.positionAt)(node.start, content);
