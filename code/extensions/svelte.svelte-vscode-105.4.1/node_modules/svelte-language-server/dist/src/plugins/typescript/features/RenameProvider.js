...
class RenameProviderImpl {
    ...
    isInSvelte2TsxPropLine(fragment, loc) {
        return (0, utils_3.isAfterSvelte2TsxPropsReturn)(fragment.text, loc.textSpan.start);
    }
    /**
    ...
    async mapAndFilterRenameLocations(renameLocations, fragments) {
        const mappedLocations = await Promise.all(renameLocations.map(async (loc) => {
            ...
            if ((0, utils_3.isNoTextSpanInGeneratedCode)(snapshot.getFullText(), loc.textSpan)) {
                return {
                    ...loc,
    ...
    mapRangeToOriginal(doc, textSpan) {
        ...
        const range = (0, documents_1.mapRangeToOriginal)(doc, (0, utils_2.convertRange)(doc, textSpan));
    ...
    checkShortHandBindingLocation(lang, renameLocations, fragments) {
        ...
        return renameLocations.map((location) => {
            ...
            const originalStart = (0, documents_1.offsetAt)(location.range.start, originalText);
            ...
            const newRange = (0, documents_1.mapRangeToOriginal)(fragment, (0, utils_2.convertRange)(fragment, {
            ...
            if (isShortHandBinding ||
                originalText
                    .substring((0, documents_1.offsetAt)(newRange.start, originalText), originalStart)
                    .trimLeft() === '{') {
