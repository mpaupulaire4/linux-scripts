...
class PluginHost {
    ...
    async getCompletions(textDocument, position, completionContext, cancellationToken) {
        ...
        const completions = (await this.execute('getCompletions', [document, position, completionContext, cancellationToken], ExecuteMode.Collect, 'high')).filter((completion) => completion != null);
    ...
    async getColorPresentations(textDocument, range, color) {
        ...
        return (0, lodash_1.flatten)(await this.execute('getColorPresentations', [document, range, color], ExecuteMode.Collect, 'low'));
    }
